...
/* Cascading operations */
	...
	std::vector<int> getAllProcessDeclarations();
	void cascadingReplaceIDNames(const std::string &oldName, const std::string &newName);
...
/* Cascade elements */
	...
	Ast* tryGetLastChild();
	//void labelStatement();
	void replaceIDNames(const std::string &oldName, const std::string &newName);
};
